...
class Profile(Base):
    ...
    skills_to_develop = Column(Text, default="[]")
...
class Match(Base):
    ...
    essay_response = Column(Text, default="")
    status = Column(String, default="pending")  # pending/interested/pending_approval/accepted/declined/completed
    created_at = Column(DateTime, default=datetime.utcnow)
...
class Notification(Base):
    ...
    type = Column(String, default="info")  # info/success/warning/action
