    ...
    <div className="max-w-5xl mx-auto px-6 py-8">
      ...
      <div className="relative overflow-hidden rounded-xl mb-8 bg-[#1A1A2E] p-8">
        ...
        <p className="text-white/80 text-sm leading-relaxed max-w-2xl mb-6">
          Explore internal gigs, projects, and roles that match your skills and aspirations. Get matched automatically based on your profile.
        </p>
        ...
        <Button asChild className="bg-brand-red hover:bg-red-700 text-white">
          <Link to="/applicant/profile">Build my profile →</Link>
        </Button>
      </div>
      ...
      {matches.length === 0
        ? <Card><CardContent className="py-10 text-center text-muted-foreground text-sm">No matches yet. <Link to="/applicant/profile" className="text-primary hover:underline">Complete your profile</Link> to get matched.</CardContent></Card>
              ...
              <Card key={m.id}>
                <CardContent className="p-4 flex items-center gap-4">
                  ...
                  <Button asChild variant="outline" size="sm">
                    <Link to="/applicant/opportunities">View</Link>
                  </Button>
                </CardContent>
              </Card>
            ))}
